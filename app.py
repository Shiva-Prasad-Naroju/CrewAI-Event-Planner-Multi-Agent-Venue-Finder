...
search_tool.args_schema = None  # allow calling without explicit parameters
...
#     'event_description': "A gathering of tech innovators, startup founders "
...
event_details = {
    'event_topic': "Startup & Innovation Conference",
    'event_description': (
        "A high-energy gathering for startup founders, "
        "tech entrepreneurs, and innovation leaders to network, "
        "share ideas, and showcase products. "
    ),
    'event_city': "Gachibowli",
    'tentative_date': "2025-08-30",
    'expected_participants': 80,
    'budget': 25000,
    'venue_type': "Startup Hub or Co-working Event Space"
}

# Since you set human_input=True for some tasks, the execution will ask for your input 
